...
class MCPServer:
    ...
    def detect_model(self, prompt):
        ...
        has_code = any(kw in lower for kw in ["code", "python", "java", "c++", "script", "program"])
        has_math = any(kw in lower for kw in ["solve", "equation", "math", "integral", "derivative", "matrix","algebra", "calculus", "limit", "factorial", "expression", "geometry","polynomial", "logarithm", "simplify", "evaluate", "probability","trigonometry", "theorem", "statistics", "vector", "function", "roots","quadratic", "mean", "median", "mode", "variance", "standard deviation"])
